...
const socials = [
  { icon: <InstagramIcon />, href: "https://www.instagram.com/mission444wellness/", label: "Instagram" },
  { icon: <FacebookIcon />, href: "https://www.facebook.com/Asuhar.B/", label: "Facebook" },
  { icon: <LinkedinIcon />, href: "https://www.linkedin.com/in/asuhar-coach/", label: "LinkedIn" },
  { icon: <WhatsappIcon />, href: "https://wa.me/mission444wellnessworld", label: "WhatsApp" },
];

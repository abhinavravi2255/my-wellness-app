...
export default function Contact() {
  ...
  const contactInfo = [
    { icon: Phone, label: "Phone / WhatsApp", value: "+91 98474 82559", sub: "+91 99474 82559", href: "tel:+919847482559", color: "#22C55E" },
    { icon: Mail, label: "Email", value: "sales@tallypro.in", sub: "support@tallypro.in", href: "mailto:sales@tallypro.in", color: "#0066FF" },
    { icon: MapPin, label: "Office Address", value: "43/1500, 2nd Floor, Palarivattom", sub: "Ernakulam, Kerala - 682025", href: "#", color: "#EC4899" },
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 1 }}>
        ...
        <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: "40px", alignItems: "start" }}>
          ...
          <div className="contact-info-container">
            ...
            <a href="https://wa.me/919847482559" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", background: "#25D366", borderRadius: "12px", padding: "14px", textDecoration: "none", color: "white", fontWeight: 700, fontSize: "15px", transition: "all 0.3s ease" }}
